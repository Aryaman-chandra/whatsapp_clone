        ...
        home: DefaultTabController(
          ...
          child: Scaffold(
              ...
              body: TabBarView(children: [
                Padding(
                  ...
                  child: ListView(
                    children: [
                      ...
                      Chat(name: 'Shagun', preview: 'Heyaa', notify: true),
                      Chat(
                      ...
                      Chat(
                          name: 'President',
                          preview: 'Sir!....We need your help!'),
                      Chat(name: 'Swarnim', preview: 'Yo'),
                      Chat(name: 'Rahul', preview: 'Helloo...'),
                ...
                ElevatedButton(onPressed: () {}, child: Icon(Icons.computer)),
                Center(
